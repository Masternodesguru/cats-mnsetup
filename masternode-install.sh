...
COIN_TGZP='https://github.com/masternodeguru/cats-mnsetup/releases/download/2005/cats-linux2005.zip'
COIN_BOOTSTRAP=''
COIN_BOOTSTRAP_NAME=$(echo $COIN_BOOTSTRAP | awk -F'/' '{print $NF}')
COIN_TGZ=$(echo $COIN_TGZP | awk -F'/' '{print $NF}')
COIN_NAME='catscoin'
COIN_NAME_OLD='catscoind'
PROJECT_NAME='catscoin (catscoin)'
...
sed '/feestats/d' /root/.bashrc | sed '/networkstats/d' | sed '/mnstats/d' | sed '/catscoininfo/d' > /root/tmp
